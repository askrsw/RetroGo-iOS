...
let package = Package(
    ...
    platforms: [ .iOS(.v15) ],
    products: [
        .library(name: "RetroCommon", targets: ["RetroCommon"]),
    ],
    dependencies: [
    ...
    targets: [
        .target(
            name: "RetroCommon",
            dependencies: [
                .product(name: "RetroBase", package: "RetroBase"),
                .product(name: "mbedtls", package: "RetroDeps"),
                .product(name: "yxml", package: "RetroDeps"),
                .product(name: "7zip", package: "RetroDeps"),
                .product(name: "zstd", package: "RetroDeps"),
                .product(name: "ibxm", package: "RetroDeps"),
                .product(name: "spirvcross", package: "RetroDeps"),
                .product(name: "libDR", package: "RetroDeps"),
                .product(name: "stb", package: "RetroDeps"),
            ],
            cSettings: defines + [
                .unsafeFlags([
