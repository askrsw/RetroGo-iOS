...
static int rcheevos_init_memory(rcheevos_locals_t* locals)
{
   ...
   const struct rc_client_game_t* game;
...
static void rcheevos_toggle_hardcore_active(rcheevos_locals_t* locals)
{
   ...
   if (!was_enabled)
   {
      ...
      if (rcheevos_is_game_loaded())
      {
         ...
         CHEEVOS_LOG("Achievements Hardcore Mode Enabled, save state & rewind were disabled.\n");
...
void rcheevos_validate_config_settings(void)
{
         ...
         && settings->uints.video_frame_delay != 0)
   {
      ...
      CHEEVOS_LOG(RCHEEVOS_TAG "Hardcore paused. Manual video frame delay setting not allowed.\n",
   ...
   if (settings->uints.video_swap_interval > 1)
   {
      ...
      CHEEVOS_LOG(RCHEEVOS_TAG "Hardcore paused. vsync swap interval above 1 not allowed.\n",
   ...
   if (settings->uints.video_black_frame_insertion > 0)
   {
      ...
      CHEEVOS_LOG(RCHEEVOS_TAG "Hardcore paused. Black frame insertion not allowed.\n",
