      ...
      void *args, void *params_data)
{
   ...
   fill_pathname_join(g_defaults.dirs[DEFAULT_DIR_OSK_OVERLAY], g_defaults.dirs[DEFAULT_DIR_OVERLAY], "keyboards", sizeof(g_defaults.dirs[DEFAULT_DIR_OSK_OVERLAY]));
