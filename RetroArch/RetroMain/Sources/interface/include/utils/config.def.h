...
/* Smooths picture. */
#if defined(GEKKO) || defined(HW_RVL) || defined(PSP) || defined(VITA) || defined(SN_TARGET_PSP2) || defined(PS2) || defined(_XBOX) || defined(DINGUX)
...
static inline bool default_use_metal_arg_buffers(void) {
    if(__builtin_available(macOS 12, iOS 13, tvOS 12, *))
        return true;
    else
        return false;
}
#define DEFAULT_USE_METAL_ARG_BUFFERS default_use_metal_arg_buffers()
#endif
...
#elif defined(PSP) || defined(HAVE_LIBNX) || defined(VITA)
...
#define DEFAULT_CONFIG_SAVE_ON_EXIT false
...
#elif defined(PSP) || defined(VITA) || defined(PS2) || defined(DINGUX)
