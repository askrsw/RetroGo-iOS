...
@property (getter=isShowLineNumber) BOOL showLineNumber;
@property (nonatomic, copy, nullable) UIColor *lineNumberTextColor;
@property (nonatomic, copy, nullable) UIColor *lineNumberBackgroundColor;
@property (nonatomic, copy, nullable) UIFont  *lineNumberFont;
@property (nonatomic, copy, nullable) UIColor *skipLineColor;
@property (nonatomic, assign) CGFloat skipLineWidth;
...
/**
 Get new line for display line numbers.
 */
...
@property (nonatomic, readonly) BOOL isShowLineNumber;

@property (nonatomic, readonly) CGFloat lineNumberWidth;
