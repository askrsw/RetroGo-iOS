...
final class GamePageInGameInfoView: UIView {
    private let attributes = GamePageInGameInfoView.makeTextAttributes(color: .white)
...
extension GamePageInGameInfoView {
